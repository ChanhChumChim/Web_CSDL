...
$db = new CreateDb("ecommerce_website", "product");
    ...
    <div class="row px-5">
        <div class="col-md-7">
            <div class="shopping-cart">
                ...
                $total = 0;
                    if (isset($_SESSION['cart'])){
                        $product_id = array_column($_SESSION['cart'], 'masp');

                        $result = $db->getData();
                        while ($row = mysqli_fetch_assoc($result)){
                            foreach ($product_id as $id){
                                if ($row['id'] == $id){
                                    cartElement($row['hinhanh'], $row['tensanpham'],$row['giasp'], $row['masp']);
                                    $total = $total + (int)$row['giasp'];
                                }
                            }
                        }
                    }else{
