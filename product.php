            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <h3>About Us</h3>
                     <ul class="about_us">
                        <li>CLA is the first retail system to be certified only ISO 9001:2000 on quality management according to international standards. Currently, CLA is the second largest retail chain in the retail technology market.</li>
                     </ul>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <h3>Contact Us</h3>
                     <ul class="conta">
                        <li>If you have any question, please contact us !</li>
                     </ul>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
